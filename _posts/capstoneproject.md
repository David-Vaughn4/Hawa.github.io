...
### **Description of final project choice, why chosen, and what a successful project would do (35/35)**
...
### **Attribution of project serving as inspiration (20/20)**
...
### **Description of how project is different than source (20/20)**
...
### **Design Specification Considerations document (25/25)**
...
Consolidated Step‑by‑Step Guide
Below is a stepwise guide combining and adapting both tutorials. You can follow this as a blueprint, adjusting for your parts, blade count, etc.
Prerequisites / parts you’ll need (adapt to your desired scale):
Addressable LED strip(s) (Neopixel, DotStar, etc.) or custom LED boards
Slip ring (3‑wire or 4‑wire depending on your LED/data lines)
Microcontroller (Arduino, or equivalent)
Power supply (sized to your LED current draw)
Fan (desk fan or ceiling fan) or custom blades
Hall effect sensor + magnet for synchronization (optional but recommended for POV)
Wires, soldering tools, glue or adhesive, mounting hardware
Light toolset: drill, Dremel, hot glue, etc.
...
### **Project Management (0/0 – not completed at this time)**

This section will be completed after final project completion.
